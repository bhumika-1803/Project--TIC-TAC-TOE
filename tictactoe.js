...
let tictac = (id) => {
  ...
  if (previous != val && (val == "o" || val == "x")) {
    ...
    if (response == true) {
      ...
      img1.src="https://cdn2.iconfinder.com/data/icons/3d-emoji-1/512/Emoji___emoticon_emoji_sticker_face_celebrate_celebration_party_right2x.png"
      let p=document.createElement("p")
      p.innerHTML=` Congratulations!! Winner is ${val.toUpperCase()} `;
      let img2=document.createElement("img")
      img2.src="https://cdn2.iconfinder.com/data/icons/3d-emoji-1/512/Emoji___emoticon_emoji_sticker_face_celebrate_celebration_party_right2x.png"
